...
codeunit 140009 "Subc. Whse Data Integrity"
{
    ...
    //     PurchaseLine.Get(PurchaseLine."Document Type", PurchaseLine."Document No.", PurchaseLine."Line No.");
    //     Assert.AreEqual(OverReceiptQuantity - OriginalQuantity, PurchaseLine."Over-Receipt Quantity",
    ...
    //     Assert.AreEqual(OverReceiptQuantity, PurchRcptLine.Quantity,
    //        'Purchase Receipt Line should have total received quantity');
    //     Assert.AreEqual(OverReceiptQuantity - OriginalQuantity, PurchRcptLine."Over-Receipt Quantity",
    ...
    //      asserterror WarehouseReceiptLine.Validate("Qty. to Receive", ExcessQuantity);
