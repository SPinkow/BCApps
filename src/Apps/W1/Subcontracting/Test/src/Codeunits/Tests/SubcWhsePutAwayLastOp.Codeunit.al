...
codeunit 140001 "Subc. Whse Put-Away LastOp."
{
    ...
    [Test]
    procedure CreatePutAwayFromWhseReceiptForLastOperationFullQuantity()
    var
        Item: Record Item;
        ...
        Quantity: Decimal;
    begin
        // [SCENARIO] Create Put-away from WH Receipt for Last Operation (Full Quantity) with Bin Mandatory location
        // [FEATURE] Subcontracting Warehouse Put-away - Last Operation
        ...
        // [THEN] Verify Bin Management: Put-away document is created
        Assert.AreNotEqual('', WarehouseActivityHeader."No.",
            'Put-away document should be created');

        // [THEN] Verify Bin Management: Put-away has correct type
        ...
        // [THEN] Verify Data Consistency: Put-away line has correct item and quantity
        // With Bin Mandatory, Take and Place lines are created
        WarehouseActivityLine.SetRange("Activity Type", WarehouseActivityLine."Activity Type"::"Put-away");
        WarehouseActivityLine.SetRange("No.", WarehouseActivityHeader."No.");
        Assert.RecordIsNotEmpty(WarehouseActivityLine);

        // Verify Take line exists and has correct item/quantity
        ...
        // [THEN] Verify Bin Management: Place line has default bin correctly assigned
        ...
        // [THEN] Verify Posted Entries: Capacity ledger entry is created
        SubcWarehouseLibrary.VerifyCapacityLedgerEntry(WorkCenter[2]."No.", Quantity);

        // [THEN] Verify Bin Management: Bin contents are correctly updated
